...
-- Leetcode
vim.api.nvim_set_keymap("n", "<leader>Lr", "<cmd>Leet run<cr>", { desc = "Run Leetcode test" })
vim.api.nvim_set_keymap("n", "<leader>Ls", "<cmd>Leet submit<cr>", { desc = "Submit Leetcode current opened question" })
